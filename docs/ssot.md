...
- 2025-12-20: Welcome 입장 시 “텍스트 + 하트스샷 가이드 이미지 1장” 발신을 재도입하고, 오픈프로필 닫기 가이드 이미지는 1장(`KakaoTalk_20251226_open_profile_close_guide.png`)만 유지하도록 정리.
...
- 2025-12-26: 오픈프로필 닫기 안내 가이드 이미지 교체(파일명 유지). bytes=425477, sha256=`E240DB9B6F4B0E27EBB59A2B1FF3A612DA1809CCE6ABA25D56FE26BE640500D2` (ADR-0045)
...
| 2025-12-19 | 공지: 이미지 전파 “성공 보고/실제 미발신” 핫픽스(에코 확인 + 중복 방지 + 결과 포맷 개선) | `docs/adr/ADR-0029-broadcast-worker-from-logstream.md`, `docs/agents.md` |
| 2025-12-20 | 공지: IRIS 이미지 전파 “1/N만 성공” 재발 방지(방별 직렬화 + echo 60s) | `docs/adr/ADR-0029-broadcast-worker-from-logstream.md`, `docs/agents.md` |
