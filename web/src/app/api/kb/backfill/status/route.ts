...
export async function GET(req: Request) {
  ...
  try {
    ...
    const url = profile ? `${KB_BASE}/backfill/status?profile=${profile}` : `${KB_BASE}/backfill/status`;
    ...
    console.warn(`[kb-proxy:${rid}] GET ${KB_BASE}/backfill/status failed: ${msg}`);
